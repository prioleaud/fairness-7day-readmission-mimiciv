...
save_results_to_file = '../results/model_hispanic_tuning/RF_isotonic.xlsx'
...
#%%
# optimal threshold 
best_classifier = RandomForestClassifier(n_estimators=200,max_features=2,criterion='gini',random_state=12)
...
plot_roc_curve(y_test, y_pred,'RF w/ isotonic calibration',
               ...
               '../results/model_black_test/roc_curve.png')
...
plot_pr_curve(y_test,y_pred,'RF w/ isotonic calibration',
               ...
               '../results/model_black_test/precision_recall_curve.png')

#Calibration Curve
plot_calibration_curve(y_test,y_pred,10,'RF w/ isotonic calibration',
                       'Calibration Plot: test set',
                       '../results/model_black_test/calibration_curve.png')
...
results_df.to_excel('../results/model_black_test/overall_model_results.xlsx',
...
subgrp_results_df.to_excel('../results/model_black_test/subgroup_results.xlsx')
...
plot_calibration_by_subgroup(test_results_df,col,true_label,pred_label,10,
                             ...
                             filename='../results/model_black_test/calibration_plot_ethnicity.png')
...
plot_calibration_by_subgroup(test_results_df,col,true_label,pred_label,10,
                             plot_title='Calibration Plot - Random Forest model',
                             filename='../results/model_black_test/calibration_plot_gender.png')
...
plot_calibration_by_subgroup(test_results_df,col,true_label,pred_label,10,
                             plot_title='Calibration Plot - Random Forest model',
                             filename='../results/model_black_test/calibration_plot_age.png')
...
plot_calibration_by_subgroup(test_results_df,col,true_label,pred_label,10,
                             plot_title='Calibration Plot - Random Forest model',
                             filename='../results/model_black_test/calibration_plot_ethnicity_gender.png')
...
fig.tight_layout()
filename = '../results/model_black_test/rf_feature_importances.png'
